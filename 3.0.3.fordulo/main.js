        ...
        if (mousex > AllX[i] && mousex < AllX[i] + width &&
            ...
            if (szint == 1) {
                ...
                if (AllTXT[i][0] == "6" && AllTXT[i][7] == "9") {
                    ...
                    plusszegy.classList.remove("plussz-egy");
                    void plusszegy.offsetWidth;
                    plusszegy.style.left="59%";//+ h ne logjon bele a szovegbe
                    plusszegy.innerHTML="+1";
                    plusszegy.classList.add("plussz-egy");
                    setTimeout(()=>{plusszegy.innerHTML="";},700);
                } else {
...
//-------------------------------jatek kezdeteig visszaszamlalo----------------
...
function KonnyuLeiras() {
    ...
    leiras.innerHTML = 
    "<p>Kódok megjelenése: mp-ként 2 <br/> Kódok eltűnése: 10 mp-ként <br/> Keresendő kódok: 8-cal kezdődő <br/> Segítségek: időlassítás,  időfagyasztás, hitstreak, jók megjelenítése <br/> Rossz kód: pontlevonás</p>";
    Animacio();
    VonalAnimacio();
}
function KozepesLeiras() {
    setTimeout(()=>{leiras.style.visibility="visible";},200);
    leiras.innerHTML = 
    "<p>Kódok megjelenése: mp-ként 1 <br/> Kódok eltűnése: 10 mp-ként <br/> Keresendő kódok: 12-vel kezdődő <br/> Segítségek: időlassítás,  időfagyasztás, hitstreak, jók megjelenítése <br/> Rossz kód: pontlevonás</p>";
    Animacio();
    VonalAnimacio();
}
function NehezLeiras() {
    setTimeout(()=>{leiras.style.visibility="visible";},200);
    leiras.innerHTML = 
    "<p>Kódok megjlenése: mp-ként 1 <br/> Kódok eltűnése: 5 mp-ként <br/> Keresendő kódok: 6-tal kezdődik és 9-ces a vége <br/> Segítségek: időlassítás,  időfagyasztás, hitstreak <br/> Rossz kód: folyamatos pontlevonás, 5 rossz kód után game over</p>";
    Animacio();
    VonalAnimacio();
}
function Animacio()
...
function Uj_Jatek() {
    ...
    pontszam = 0;
    szint = 0;
    timertxt.classList.remove("gameover-anim"); //+ hogy uj jateknal ne legyen animacioja az idonek
    pontmutato.classList.remove("gameover-anim"); //+ hogy a pont helyett a game overnek legyen animacio es h uj jateknal ne legyen rajta
    timertxt.innerHTML = "Hátralévő idő: " + hatralevo_ido;
    pontmutato.innerHTML = "Pontszám: " + pontszam;
    ctx.clearRect(0, 0, 750, 500);
    clearInterval(level__1_timer);
    clearInterval(level__2_timer);
    clearInterval(level__3_timer);
    clearInterval(global_timer);
    clearInterval(szamlalo);//+++++++
