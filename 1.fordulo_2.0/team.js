...
let sorszam = 0;
function Lapoz() {
    const kephelye = document.querySelector("#kepek");
    sorszam++;
    if (sorszam == 1) {
        if (document.querySelector("#letezik") != null && document.querySelector("#letezik") != undefined) {
            document.querySelector("#letezik").remove();           
        }
        const kep = document.createElement("IMG");
        kep.id = "letezik";
        kep.src = "./C.png";
        kep.style.border = "none";
        kephelye.appendChild(kep);
    } else if (sorszam == 2) {
        if (document.querySelector("#letezik") != null && document.querySelector("#letezik") != undefined) {
            document.querySelector("#letezik").remove();           
        }
