...
const fagyashoz=document.querySelector("#fagyashoz"); //fagyashoz
...
vonal.style.width="50%";//+ hosszabb vonal
vonal.style.marginTop="10px";//+ nagyobb margo felul
...
function ElsoSzint() {
    rndtime = Math.floor(Math.random()*(10-1+1))+1;
    console.log(rndtime);
...
function Uj_Jatek() {
    ...
    clearInterval(lassitanim);//idolassit anim
    clearInterval(lassitanim2);//idolassit anim
}
