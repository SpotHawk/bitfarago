...
let rndtime = (Math.floor(Math.random()*(5-1+1))+1)*1000;
let global_timer = "";
...
let eltunes = "";
let level_timer = "";
// VISSZASZÁMLÁLÁS A JÁTÉK KEZDETÉTŐL A VÉGÉIG
//-------------------------------------------------------------------------------
function idozito () { 
...
function ElsoSzint() {
    ...
    rndtime = Math.floor((Math.random()*(3-1+1))+1)*1000;
    console.log(rndtime);
    level_timer = setInterval(ElsoSzint, rndtime);
    }
}
...
function MasodikSzint() {
    ...
    rndtime = Math.floor((Math.random()*(5-1+1))+1)*1000;
    console.log(rndtime);
    level_timer = setInterval(ElsoSzint, rndtime);
}
}
...
function Konnyu() {
    ...
    LeirasSzamlalo();
    setTimeout(() => {
        level_timer = setInterval(ElsoSzint, rndtime),idozito()
    }, 3000);
}
function Kozepes() {
    szint = 2;
    ...
    LeirasSzamlalo();
    setTimeout(() => {
        level_timer = setInterval(MasodikSzint(), rndtime),idozito()
    }, 3000);
}
function Nehez() {
    szint = 3;
    ...
    jatekmenu.style.visibility = "visible";
     ...
     LeirasSzamlalo();
     setTimeout(() => {
        level_timer = setInterval(HarmadikSzint(), rndtime),idozito()
    }, 3000);
}
function Uj_Jatek() {
